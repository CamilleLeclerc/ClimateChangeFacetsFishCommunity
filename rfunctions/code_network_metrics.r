...
#CalculatePredatorOverlap function from Arnaud's script
#This function calculates the connectivity of the predator-predator undirected network
#in which a link is shared between predators that share at least one prey
