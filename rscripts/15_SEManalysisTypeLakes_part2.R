...
## LOAD DATASETS
##--------------
myload(sem_effect_reservoir_lakes, sem_effect_natural_lakes,
       dir = "outputs/SEM")
...
## PREPARE DATASETS
##-----------------
sem_effect_reservoir_lakes$lake.type <- "reservoir"
sem_effect_natural_lakes$lake.type <- "natural"
data.effect <- rbind(sem_effect_reservoir_lakes, sem_effect_natural_lakes)
str(data.effect)
