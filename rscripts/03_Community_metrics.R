...
## LOAD DATASETS
##--------------
myload(ind_size, sampling_protocol, station, dir = "data")
...
mysave(weight_fish_lake, dir = "data", overwrite = TRUE)
...
mysave(community_lake, dir = "data", overwrite = TRUE)
...
mysave(community_lake_metrics, dir = "data", overwrite = TRUE)
